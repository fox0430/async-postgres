...
nameAccessorScale(getMoney, PgMoney)
...
nameAccessorScale(getMoneyArray, seq[PgMoney])
...
nameAccessorScale(getMoneyArrayND, PgArray[PgMoney])
nameAccessorScale(getMoneyArrayNDOpt, Option[PgArray[PgMoney]])
