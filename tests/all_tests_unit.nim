...
import
  test_async_backend, test_auth, test_dsn, test_fill_recvbuf, test_keepalive,
  test_listen_reconnect, test_network_failure, test_physical_replication, test_pool,
  test_pool_cluster, test_protocol, test_protocol_fuzz, test_replication,
  test_replication_keepalive, test_rowdata, test_saslprep, test_session_attrs, test_sql,
  test_ssl, test_transaction_cancel, test_tx_cleanup_defect, test_types
{.pop.}
